...
export default function Footer() {
  return (
    <footer id="footer" className="bg-len-primary text-len-primary-text py-16 relative border-t-4 border-dashed border-white/20 mt-20">
      <div className="container mx-auto px-4 flex flex-col items-center justify-center gap-8">
        ...
        <div className="text-center pt-8 border-t-2 border-dashed border-white/10 w-full max-w-lg">
